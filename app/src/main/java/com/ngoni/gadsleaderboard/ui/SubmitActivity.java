...
import com.ngoni.gadsleaderboard.apiclient.SubmitAPIInterface;
...
public class SubmitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SubmitAPIInterface googleForms = retrofitSubmit.create(SubmitAPIInterface.class);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (firstNameInput.getText().toString().isEmpty() || lastNameInput.getText().toString().isEmpty() || emailInput.getText().toString().isEmpty() || projectLinkInput.getText().toString().isEmpty()) {
                    Toast.makeText(SubmitActivity.this, "Details not complete", Toast.LENGTH_SHORT).show();
                } else {

                    custom_dialog.setContentView(R.layout.custom_screen);
